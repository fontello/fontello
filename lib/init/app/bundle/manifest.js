...
function compile(tmpdir, config, callback) {
  ...
  filters     = [],
  blacklist   = [],
  files       = _.values(N.runtime.assets.bin);

  filters.push('fontello/javascripts/app.js');
  filters.push('fontello/javascripts/loader.js');
  filters.push('fontello/vendor/json2.js', 'fontello/vendor/es5-shim.js');
